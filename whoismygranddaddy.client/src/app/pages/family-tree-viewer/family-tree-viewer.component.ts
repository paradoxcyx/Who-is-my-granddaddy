...
export class FamilyTreeViewerComponent implements OnInit, AfterViewInit {
  name = 'Angular';

  @ViewChild(DiagramComponent, {static: false}) diagramComponent: DiagramComponent | undefined;
  ...
  @ViewChild('myDiag', {static: false}) myDiag: DiagramComponent | undefined;
  ...
  ngAfterViewInit() {
    ...
    const appComp: FamilyTreeViewerComponent = this;
    this.myDiag!.diagram.nodeTemplate.contextMenu =
      $('ContextMenu',
        ...
        $('ContextMenuButton',
          $(go.TextBlock, 'Not Working Button2'),
          {
            click: (e, obj) => {
